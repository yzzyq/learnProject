...
# 得出主信息的置信度
def getFluxData(dataSet, two_centers, dataProcess, allPoistion, other_centers, dis_threshold):
    ...
    for data_index in range(len_dataSet):
        ...
        if dataProcess[data_index, -1] != -1:
            ...
            aroundData = adc.getAroundData(data_index, allPoistion, dis_threshold)
            sourroundData = [dataSet[sourround_index] for sourround_index in aroundData]
                            ...
                            if abs(before_slope) > 0.02 and abs(slope) > 0.02:
                                if center - 1 < data[0][i] < center:
                                    ...
                                    if (data[1][i+2] - data[1][i+1])/(data[0][i+2] - data[0][i+1]) <= 0 and \
                                        (data[1][i+3] - data[1][i+2])/(data[0][i+3] - data[0][i+2]) > 0 and \
                                        (data[1][i-1] - data[1][i-2])/(data[0][i-1] - data[0][i-2]) < 0 and \
                                        (data[1][i] - data[1][i+1]) / (data[1][i] - data[1][i-1]) < 0.1:
                                        isMout = False
                                        break 
                                    
                                    # print((data[1][i+1] - data[1][i+2]) / (data[1][i] - data[1][i+1]))
                                    # print((data[1][i+4] - data[1][i+2]) / (data[1][i] - data[1][i+2]))
                                    if (data[1][i+2] - data[1][i+1])/(data[0][i+2] - data[0][i+1]) < 0 and \
                                        (data[1][i+3] - data[1][i+2])/(data[0][i+3] - data[0][i+2]) > 0 and \
                                        (data[1][i+4] - data[1][i+3])/(data[0][i+4] - data[0][i+3]) > 0 and \
                                        (data[1][i-1] - data[1][i-2])/(data[0][i-1] - data[0][i-2]) < 0 and \
                                        (data[1][i+1] - data[1][i+2]) / (data[1][i] - data[1][i+1]) < 0.2 and \
                                        0.7 < (data[1][i+4] - data[1][i+2]) / (data[1][i] - data[1][i+2]) < 1.3:
                                        isMout = False
                                        break 
                                ...
                                if center-2 < data[0][i] < center - 1:
                                    ...
                                    if (data[1][i+2] - data[1][i+1])/(data[0][i+2] - data[0][i+1]) < 0 and \
                                        ...
                                        (data[1][i-1] - data[1][i-2])/(data[0][i-1] - data[0][i-2]) > 0 and \
                                        (data[1][i-2] - data[1][i-3])/(data[0][i-2] - data[0][i-3]) < 0 and \
                                        (data[1][i+1] - data[1][i+2])/(data[1][i] - data[1][i+1]) < 0.3 and \
                                        0.5 < (data[1][i+3] - data[1][i+2])/(data[1][i] - data[1][i+2]) < 1:
                                        isMout = False
                                        break
                                    ...
                                    if ((data[1][i-1] - data[1][i-2])/(data[0][i-1] - data[0][i-2])) > 0 and \
                                       ...
                                       ((data[1][i+2] - data[1][i+1])/(data[0][i+2] - data[0][i+1])) > 0 and \
                                        center == 4862 and \
                                        (data[1][i] - data[1][i+1]) / (data[1][i+3] - data[1][i+1]) < 0.2:
                                        isMout = False
                                        break
                                    
                                    # print((data[1][i] - data[1][i-1]) / (data[1][i] - data[1][i+3]))
                                    if ((data[1][i-1] - data[1][i-2])/(data[0][i-1] - data[0][i-2])) < 0 and \
                                        ((data[1][i+4] - data[1][i+3])/(data[0][i+4] - data[0][i+3])) > 0 and \
                                       ((data[1][i+3] - data[1][i+2])/(data[0][i+3] - data[0][i+2])) < 0 and \
                                       ((data[1][i+2] - data[1][i+1])/(data[0][i+2] - data[0][i+1])) < 0 and \
                                        center == 4862 and \
                                        (data[1][i] - data[1][i-1]) / (data[1][i] - data[1][i+3]) < 0.2:
                                        isMout = False
                                        break
                                    ...
                                    # print((data[1][i+2] - data[1][i+3]) / (data[1][i] - data[1][i+2]))
                                    if ((data[1][i-1] - data[1][i-2])/(data[0][i-1] - data[0][i-2])) < 0 and \
                                        ((data[1][i+4] - data[1][i+3])/(data[0][i+4] - data[0][i+3])) > 0 and \
                                       ((data[1][i+3] - data[1][i+2])/(data[0][i+3] - data[0][i+2])) < 0 and \
                                       ((data[1][i+2] - data[1][i+1])/(data[0][i+2] - data[0][i+1])) < 0 and \
                                        center == 4862 and \
                                       (data[1][i+2] - data[1][i+3]) / (data[1][i] - data[1][i+2]) < 0.2:
                                        isMout = False
                                        break
                                    ...
                                    if ((data[1][i-1] - data[1][i-2])/(data[0][i-1] - data[0][i-2])) > 0 and \
                                       ...
                                       ((data[1][i+2] - data[1][i+1])/(data[0][i+2] - data[0][i+1])) > 0 and \
                                        center == 4862 and \
                                       (data[1][i] - data[1][i+1]) / (data[1][i+3] - data[1][i+1]) < 0.5:
                                        isMout = False
                                        break
                                    ...
                                    if ((data[1][i+5] - data[1][i+4])/(data[0][i+5] - data[0][i+4])) > 0 and \
                                       ...
                                       ((data[1][i+2] - data[1][i+1])/(data[0][i+2] - data[0][i+1])) > 0 and \
                                        ((data[1][i-1] - data[1][i-2])/(data[0][i-1] - data[0][i-2])) > 0 and \
                                        ((data[1][i-2] - data[1][i-3])/(data[0][i-2] - data[0][i-3])) < 0 and \
                                       0.5 < (data[1][i] - data[1][i+1]) / (data[1][i+5] - data[1][i+1]) < 1.5:
                                        isMout = False
                                        break
